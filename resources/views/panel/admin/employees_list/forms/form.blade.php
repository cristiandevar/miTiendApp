    ...
    <form action="{{ $employee->id ? route('employee.update', $employee) : route('employee.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="firstname" name="firstname" value="{{ old('firstname', optional($employee)->firstname) }}" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control" id="dni" name="dni" value="{{ old('dni', optional($employee)->dni) }}" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="email" name="email" value="{{ old('email', optional($employee)->email) }}">
                </div>
            </div>
