    ...
    <header class="clearfix"> --}}
      ...
      <body>
          <header>
            ...
            <div id="project">
              <div><span>Ordenado por: </span> {{ $order_by }} </div>
              <div><span>De manera: </span> {{ $order_type }} </div>
              {{-- <div><span>Email</span> <a href="mailto:{{ $data['supplier']->email}}">{{ $data['supplier']->email}}</a></div> --}}
              <div><span>Fecha Creación</span> {{ today()->format('d/m/Y')}}</div>
            </div>
          </header>
          <main>
            <table>
          ...
          <footer>
            Listado Generado por <strong>"miTiendAPP"</strong>
          </footer>
        </body>
        {{-- </body>
      </html> --}}
